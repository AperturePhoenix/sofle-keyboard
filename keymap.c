...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT(// MAIN
    ...
    KC_LSFT,        KC_Z,  KC_X,     KC_C,     KC_V,     KC_B,    KC_MPLY,          KC_DEL,   KC_N,     KC_M,     KC_COMM,  KC_DOT,  KC_SLSH,  KC_RSFT,
                           KC_LGUI,  KC_LALT,  KC_LCTL,  KC_SPC,  LT(1, KC_ENT),    KC_BSPC,  KC_QUOT,  KC_MINS,  KC_GRV,   TG(2) 
  ),
  LAYOUT( // FN
    ...
    KC_LSFT,  KC_MUTE,  KC_MRWD,  KC_MFFD,  KC_MPRV,   KC_MNXT,  KC_NO,       KC_NO,     KC_PAST,  KC_P1,  KC_P2,    KC_P3,  KC_PENT,  RGB_RMOD,
                        KC_NO,    KC_NO,    KC_NO,     TG(3),    KC_NO,       KC_BSPC,   KC_NO,    KC_P0,  KC_PDOT,  KC_NO
  ),
  LAYOUT( // GAME
    ...
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,      KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,
                        KC_LCTL,  KC_TRNS,  KC_LGUI,  KC_TRNS,  KC_TRNS,      KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS 
  ),
  LAYOUT( // GAME
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,                          KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,                          KC_TRNS,  KC_TRNS,  KC_UP,    KC_TRNS,   KC_TRNS,  KC_TRNS,
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,                          KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_RIGHT,  KC_TRNS,  KC_TRNS,
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,      KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  LT(1, KC_ENT),
                        KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  SH_MON,       KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  TG(3) 
  )
};
